...
# ACDS 23.1 993 linux 2025.06.01.18:28:32
...
TOP_LEVEL_NAME="pll"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/eda/intelFPGALite/23.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll.vo"
fi
